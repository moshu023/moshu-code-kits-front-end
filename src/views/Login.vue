    ...
    <div class="box">
      ...
      <div class="form">
        ...
        <el-form :model="loginForm" ref="loginForm" :rules="rules">
          ...
          <div class="inputBoxForCheck">
            <el-form-item prop="verifyCode">
              <el-input type="text" placeholder="验证码" v-model="loginForm.verifyCode" prop="verifyCode"
                        onfocus="this.placeholder=''" onblur="this.placeholder='验证码'"/>
              <div style=" position:absolute;display:inline-block;margin-left: 10px;">
                <img alt="点击刷新" src='http://localhost:8085/user/check' style="border-radius: 25px;"
        ...
        <div class="inputBox" style="display: flex;align-items: center">
          <el-button class="btn center" @click="useLlogin" style="background-color: #67bfe5; color: #fff;display: inline-block">登录
          </el-button>
          <el-button class="btn center" @click="useLlogin"
